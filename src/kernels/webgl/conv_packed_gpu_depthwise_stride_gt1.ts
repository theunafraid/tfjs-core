...
export class DepthwiseConv2DStrideGT1PackedProgram implements GPGPUProgram {
  variableNames = ['x', 'W'];
  ...
  constructor(convInfo: Conv2DInfo) {
    ...
    const texelsAcross = Math.ceil((filterWidth + 1) * strideWidth / 2);

    let mainLoop = `int xR; int xC; vec4 xTexel = vec4(0.0);`;
